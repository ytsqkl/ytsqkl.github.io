...
if DEFINED _Office%1Path (
    ...
    cscript //nologo ospp.vbs /sethst:kms.chinancce.com >nul
...
if defined %EditionID% (
	...
	cscript //Nologo %windir%\system32\slmgr.vbs /skms kms.chinancce.com
